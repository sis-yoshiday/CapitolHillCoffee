...
public class CoffeeFetcher {
  ...
  private static final CoffeeShop[] COFFEE_SHOPS = {
      new CoffeeShop("Joe Bar Cafe", "810 East Roy Street", "(206) 324-0407",
          new GeoPoint(47625148, -122321623)),
      new CoffeeShop("Roy Street Coffee and Tea", "700 Broadway Ave East", "(206) 325-2211",
          new GeoPoint(47625206, -122321108)),
      new CoffeeShop("Vivace Espresso Bar", "532 Broadway Ave East", "(206) 860-2722",
          new GeoPoint(47623749, -122320861)),
      new CoffeeShop("Dilettante Mocha Cafe", "538 Broadway Ave East", "(206) 329-6463",
          new GeoPoint(47623922, -122320861)),
      new CoffeeShop("Starbucks", "700 Broadway Ave East", "(206) 325-2211",
          new GeoPoint(47625495, -122321287)),
      new CoffeeShop("Starbucks", "434 Broadway Ave East", "(206) 323-7888",
          new GeoPoint(47623058, -122320792)),
      new CoffeeShop("Cafe Canape", "700 Broadway Ave East", "(206) 708-1210",
   ...
   */
  public static void fetchCoffee(final GeoPoint mapCenter, final int zoomLevel,
